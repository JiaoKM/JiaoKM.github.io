...
$(function(){
 ...
 // StableNormal
 $(function(){
    $.get("./abs/stablenormal.txt", function(data) {
       $("#stablenormalabs").html(data);
    });
 });
 
 $(function(){
    $.get("./bib/stablenormal.txt", function(data) {
       $("#stablenormalbib").html(data);
    });
 });
 
 // G-Shell
 $(function(){
    $.get("./abs/gshell.txt", function(data) {
       $("#gshellabs").html(data);
    });
 });
 
 $(function(){
    $.get("./bib/gshell.txt", function(data) {
       $("#gshellbib").html(data);
    });
 });
 ...
 // BOFT
 $(function(){
    $.get("./abs/boft.txt", function(data) {
       $("#boftabs").html(data);
    });
 });
 
 $(function(){
    $.get("./bib/boft.txt", function(data) {
       $("#boftbib").html(data);
    });
 });
 ...
 // TADA
 $(function(){
    $.get("./abs/tada.txt", function(data) {
       $("#tadaabs").html(data);
    });
 });
 
 $(function(){
    $.get("./bib/tada.txt", function(data) {
       $("#tadabib").html(data);
    });
 });
 ...
 // TeCH
 $(function(){
    $.get("./abs/tech.txt", function(data) {
       $("#techabs").html(data);
    });
 });
 
 $(function(){
    $.get("./bib/tech.txt", function(data) {
       $("#techbib").html(data);
    });
 });
